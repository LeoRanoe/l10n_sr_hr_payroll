...
class TestArtikel14Breakdown(common.TransactionCase):
    ...
    def test_breakdown_dict_bevat_alle_sleutels(self):
        ...
        verwachte_sleutels = [
            ...
            'basic', 'toelagen', 'kinderbijslag', 'kb_belastbaar', 'kb_vrijgesteld', 'vrijgesteld_contract',
            'vgb_belastbaar',
            ...
            'tax_brackets',
            'lb_voor_heffingskorting_jaar', 'heffingskorting_per_periode', 'lb_jaar', 'lb_per_periode',
            ...
            'earnings_lines', 'deductions_lines', 'summary_cards', 'hours_summary_lines', 'worked_days_rows',
